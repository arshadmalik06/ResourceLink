...
import { EncodedMultisig, EncodedPQSig } from './types/transactions/encoded.js';
...
export declare const PROGRAM_TAG: Uint8Array;
export declare const PQ_PROGRAM_TAG: Uint8Array;
export declare const MSIG_PROGRAM_TAG: Uint8Array;
/**
...
export declare class LogicSig implements encoding.Encodable {
     ...
     */
    signWithSigner(signer: DelegatedLsigSigner, msig?: MultisigMetadata): Promise<Address>;
    /**
    ...
    appendToMultisigWithSigner(signer: DelegatedLsigSigner): Promise<void>;
    /**
     ...
     */
    signDataWithSigner(signer: ProgramDataSigner, data: Uint8Array): Promise<Uint8Array>;
}
/**
...
export declare class LogicSigAccount implements encoding.Encodable {
    ...
    signMultisigWithSigner(msig: MultisigMetadata, signer: DelegatedLsigSigner): Promise<void>;
    /**
     ...
     */
    signWithSigner(signer: DelegatedLsigSigner): Promise<void>;
}
/**
...
export declare const SIGN_PROGRAM_DATA_PREFIX: Uint8Array;
/**
