...
import type { EncodedMultisig, EncodedPQSig } from './types/transactions/encoded.js';
 ...
 * */
export type DelegatedLsigSigner = (lsig: LogicSig, msig?: MultisigMetadata) => Promise<{
    address: Address;
} & ({
    sig: Uint8Array;
} | {
 ...
 */
export declare function makeEmptyTransactionSigner(): TransactionSigner;
