 ...
 */
export declare function isTransactionType(s: string): s is TransactionType;
/**
 ...
 */
export declare function isOnApplicationComplete(v: unknown): v is OnApplicationComplete;
/**
