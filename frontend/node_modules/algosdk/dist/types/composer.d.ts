...
import { SimulateRequest, PendingTransactionResponse, SimulateResponse } from './client/v2/algod/models/types.js';
import { Address } from './encoding/address.js';
import { TransactionSigner, TransactionWithSigner } from './signer.js';
...
export declare class AtomicTransactionComposer {
     ...
     */
    submit(client: AlgodClient): Promise<string[]>;
    /**
     ...
     */
    simulate(client: AlgodClient, request?: SimulateRequest): Promise<{
     ...
     */
    execute(client: AlgodClient, waitRounds: number): Promise<{
