...
exports.AlgodClient = void 0;
const serviceClient_js_1 = __importDefault(require("../serviceClient.js"));
const modelsv2 = __importStar(require("./models/types.js"));
const accountInformation_js_1 = __importDefault(require("./accountInformation.js"));
const accountAssetInformation_js_1 = __importDefault(require("./accountAssetInformation.js"));
const accountAssetsInformation_js_1 = __importDefault(require("./accountAssetsInformation.js"));
const accountApplicationsInformation_js_1 = __importDefault(require("./accountApplicationsInformation.js"));
const accountApplicationInformation_js_1 = __importDefault(require("./accountApplicationInformation.js"));
const block_js_1 = __importDefault(require("./block.js"));
const compile_js_1 = __importDefault(require("./compile.js"));
const genesis_js_1 = __importDefault(require("./genesis.js"));
const getAssetByID_js_1 = __importDefault(require("./getAssetByID.js"));
const getApplicationByID_js_1 = __importDefault(require("./getApplicationByID.js"));
const getBlockHash_js_1 = __importDefault(require("./getBlockHash.js"));
const getBlockTxids_js_1 = __importDefault(require("./getBlockTxids.js"));
const getApplicationBoxByName_js_1 = __importDefault(require("./getApplicationBoxByName.js"));
const getApplicationBoxes_js_1 = __importDefault(require("./getApplicationBoxes.js"));
const healthCheck_js_1 = __importDefault(require("./healthCheck.js"));
const pendingTransactionInformation_js_1 = __importDefault(require("./pendingTransactionInformation.js"));
const pendingTransactions_js_1 = __importDefault(require("./pendingTransactions.js"));
const pendingTransactionsByAddress_js_1 = __importDefault(require("./pendingTransactionsByAddress.js"));
const getTransactionProof_js_1 = __importDefault(require("./getTransactionProof.js"));
const sendRawTransaction_js_1 = __importDefault(require("./sendRawTransaction.js"));
const status_js_1 = __importDefault(require("./status.js"));
const statusAfterBlock_js_1 = __importDefault(require("./statusAfterBlock.js"));
const suggestedParams_js_1 = __importDefault(require("./suggestedParams.js"));
const supply_js_1 = __importDefault(require("./supply.js"));
const versions_js_1 = __importDefault(require("./versions.js"));
const lightBlockHeaderProof_js_1 = __importDefault(require("./lightBlockHeaderProof.js"));
const stateproof_js_1 = __importDefault(require("./stateproof.js"));
const setSyncRound_js_1 = __importDefault(require("./setSyncRound.js"));
const getSyncRound_js_1 = __importDefault(require("./getSyncRound.js"));
const setBlockOffsetTimestamp_js_1 = __importDefault(require("./setBlockOffsetTimestamp.js"));
const getBlockOffsetTimestamp_js_1 = __importDefault(require("./getBlockOffsetTimestamp.js"));
const disassemble_js_1 = __importDefault(require("./disassemble.js"));
const simulateTransaction_js_1 = __importDefault(require("./simulateTransaction.js"));
...
const unsetSyncRound_js_1 = __importDefault(require("./unsetSyncRound.js"));
const getLedgerStateDeltaForTransactionGroup_js_1 = __importDefault(require("./getLedgerStateDeltaForTransactionGroup.js"));
const getLedgerStateDelta_js_1 = __importDefault(require("./getLedgerStateDelta.js"));
const getTransactionGroupLedgerStateDeltasForRound_js_1 = __importDefault(require("./getTransactionGroupLedgerStateDeltasForRound.js"));
/**
 ...
 */
class AlgodClient extends serviceClient_js_1.default {
    /**
     ...
     */
    healthCheck() {
        return new healthCheck_js_1.default(this.c);
    }
    /**
     ...
     */
    versionsCheck() {
        return new versions_js_1.default(this.c);
    }
    /**
    ...
    sendRawTransaction(stxOrStxs) {
        return new sendRawTransaction_js_1.default(this.c, stxOrStxs);
    }
    /**
    ...
    accountInformation(account) {
        return new accountInformation_js_1.default(this.c, account);
    }
    /**
    ...
    accountAssetInformation(account, index) {
        return new accountAssetInformation_js_1.default(this.c, account, index);
    }
    /**
     ...
     * @category GET
     */
    accountAssetsInformation(account) {
        return new accountAssetsInformation_js_1.default(this.c, account);
    }
    /**
     ...
     * @category GET
     */
    accountApplicationsInformation(account) {
        return new accountApplicationsInformation_js_1.default(this.c, account);
    }
    /**
    ...
    accountApplicationInformation(account, index) {
        return new accountApplicationInformation_js_1.default(this.c, account, index);
    }
    /**
     ...
     */
    block(roundNumber) {
        return new block_js_1.default(this.c, roundNumber);
    }
    /**
    ...
    getBlockHash(roundNumber) {
        return new getBlockHash_js_1.default(this.c, roundNumber);
    }
    /**
    ...
    getBlockTxids(roundNumber) {
        return new getBlockTxids_js_1.default(this.c, roundNumber);
    }
    /**
    ...
    pendingTransactionInformation(txid) {
        return new pendingTransactionInformation_js_1.default(this.c, txid);
    }
    /**
     ...
     */
    pendingTransactionsInformation() {
        return new pendingTransactions_js_1.default(this.c);
    }
    /**
     ...
     */
    pendingTransactionByAddress(address) {
        return new pendingTransactionsByAddress_js_1.default(this.c, address);
    }
    /**
     ...
     */
    status() {
        return new status_js_1.default(this.c);
    }
    /**
    ...
    statusAfterBlock(round) {
        return new statusAfterBlock_js_1.default(this.c, round);
    }
    /**
    ...
    getTransactionParams() {
        return new suggestedParams_js_1.default(this.c);
    }
    /**
     ...
     */
    supply() {
        return new supply_js_1.default(this.c);
    }
    /**
     ...
     */
    compile(source) {
        return new compile_js_1.default(this.c, source);
    }
    /**
     ...
     */
    disassemble(source) {
        return new disassemble_js_1.default(this.c, source);
    }
    /**
     ...
     */
    getAssetByID(index) {
        return new getAssetByID_js_1.default(this.c, index);
    }
    /**
    ...
    getApplicationByID(index) {
        return new getApplicationByID_js_1.default(this.c, index);
    }
    /**
    ...
    getApplicationBoxByName(index, boxName) {
        return new getApplicationBoxByName_js_1.default(this.c, index, boxName);
    }
    /**
    ...
    getApplicationBoxes(index) {
        return new getApplicationBoxes_js_1.default(this.c, index);
    }
    /**
     ...
     */
    genesis() {
        return new genesis_js_1.default(this.c);
    }
    /**
    ...
    getTransactionProof(round, txID) {
        return new getTransactionProof_js_1.default(this.c, round, txID);
    }
    /**
    ...
    getLightBlockHeaderProof(round) {
        return new lightBlockHeaderProof_js_1.default(this.c, round);
    }
    /**
     ...
     */
    getStateProof(round) {
        return new stateproof_js_1.default(this.c, round);
    }
    /**
    ...
    simulateRawTransactions(stxOrStxs) {
        ...
        if (Array.isArray(stxOrStxs)) {
            for (const stxn of stxOrStxs) {
                txnObjects.push(encoding.decodeMsgpack(stxn, signedTransaction_js_1.SignedTransaction));
            }
        }
        else {
            txnObjects.push(encoding.decodeMsgpack(stxOrStxs, signedTransaction_js_1.SignedTransaction));
        }
    ...
    simulateTransactions(request) {
        return new simulateTransaction_js_1.default(this.c, request);
    }
    /**
    ...
    setBlockOffsetTimestamp(offset) {
        return new setBlockOffsetTimestamp_js_1.default(this.c, offset);
    }
    /**
    ...
    getBlockOffsetTimestamp() {
        return new getBlockOffsetTimestamp_js_1.default(this.c);
    }
    /**
     ...
     */
    setSyncRound(round) {
        return new setSyncRound_js_1.default(this.c, round);
    }
    /**
     ...
     */
    unsetSyncRound() {
        return new unsetSyncRound_js_1.default(this.c);
    }
    /**
     ...
     */
    getSyncRound() {
        return new getSyncRound_js_1.default(this.c);
    }
    /**
     ...
     */
    ready() {
        return new ready_js_1.default(this.c);
    }
    /**
    ...
    getLedgerStateDeltaForTransactionGroup(id) {
        return new getLedgerStateDeltaForTransactionGroup_js_1.default(this.c, id);
    }
    /**
    ...
    getLedgerStateDelta(round) {
        return new getLedgerStateDelta_js_1.default(this.c, round);
    }
    /**
    ...
    getTransactionGroupLedgerStateDeltasForRound(round) {
        return new getTransactionGroupLedgerStateDeltasForRound_js_1.default(this.c, round);
    }
}
exports.AlgodClient = AlgodClient;
