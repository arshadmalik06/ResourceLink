...
class AccountApplicationResource {
    ...
    constructor({ id, appLocalState, createdAtRound, deleted, params, }) {
        this.id = (0, utils_js_1.ensureSafeInteger)(id);
        this.appLocalState = appLocalState;
        this.createdAtRound =
            typeof createdAtRound === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureSafeInteger)(createdAtRound);
...
exports.AccountApplicationResource = AccountApplicationResource;
/**
...
class AccountApplicationsInformationResponse {
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            ...
            this.encodingSchemaValue.pushEntries({ key: 'round', valueSchema: new index_js_1.Uint64Schema(), omitEmpty: true }, {
                ...
                valueSchema: new index_js_1.OptionalSchema(new index_js_1.ArraySchema(AccountApplicationResource.encodingSchema)),
                omitEmpty: true,
            }, {
                key: 'next-token',
                valueSchema: new index_js_1.OptionalSchema(new index_js_1.StringSchema()),
    ...
    static fromEncodingData(data) {
        if (!(data instanceof Map)) {
            throw new Error(`Invalid decoded AccountApplicationsInformationResponse: ${data}`);
        }
        return new AccountApplicationsInformationResponse({
            round: data.get('round'),
            applicationResources: typeof data.get('application-resources') !== 'undefined'
                ? data
                    .get('application-resources')
                    .map((v) => AccountApplicationResource.fromEncodingData(v))
                : undefined,
            nextToken: data.get('next-token'),
        });
    }
}
exports.AccountApplicationsInformationResponse = AccountApplicationsInformationResponse;
/**
    ...
    constructor({ approvalProgram, clearStateProgram, creator, extraProgramPages, familyBoxAccess, foreignBoxReads, globalState, globalStateSchema, localStateSchema, sizeSponsor, version, }) {
        ...
        this.sizeSponsor =
            typeof sizeSponsor === 'string'
                ? address_js_1.Address.fromString(sizeSponsor)
                : sizeSponsor;
        this.version =
...
class GetPeersResponse {
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            ...
            this.encodingSchemaValue.pushEntries({
                key: 'Peers',
                valueSchema: new index_js_1.ArraySchema(PeerStatus.encodingSchema),
                omitEmpty: true,
            });
        }
        return this.encodingSchemaValue;
    ...
    static fromEncodingData(data) {
        ...
        return new GetPeersResponse({
            peers: (data.get('Peers') ?? []).map((v) => PeerStatus.fromEncodingData(v)),
        });
    }
}
exports.GetPeersResponse = GetPeersResponse;
/**
    ...
    constructor({ txnResults, appBudgetAdded, appBudgetConsumed, failedAt, failureMessage, groupFeesPaid, groupUsage, unnamedResourcesAccessed, }) {
        ...
        this.groupFeesPaid =
            typeof groupFeesPaid === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureSafeInteger)(groupFeesPaid);
        this.groupUsage =
            typeof groupUsage === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureSafeInteger)(groupUsage);
...
class SimulateTransactionResult {
    ...
    constructor({ txnResult, appBudgetConsumed, execTrace, feesPaid, fixedSigner, logicSigBudgetConsumed, unnamedResourcesAccessed, }) {
        ...
        this.feesPaid =
            typeof feesPaid === 'undefined' ? undefined : (0, utils_js_1.ensureSafeInteger)(feesPaid);
        this.fixedSigner =
...
class SupplyResponse {
    ...
    constructor({ currentRound, onlineMoney, onlineStake, totalMoney, }) {
        ...
        this.onlineStake = (0, utils_js_1.ensureBigInt)(onlineStake);
