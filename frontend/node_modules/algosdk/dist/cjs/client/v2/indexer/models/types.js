...
exports.StateProofVerifier = exports.StateProofTracking = exports.StateProofSignature = exports.StateProofSigSlot = exports.StateProofReveal = exports.StateProofParticipant = exports.StateProofFields = exports.ResourceRef = exports.ParticipationUpdates = exports.MiniAssetHolding = exports.MerkleArrayProof = exports.LocalsRef = exports.IndexerStateProofMessage = exports.HoldingRef = exports.HealthCheck = exports.HbProofFields = exports.HashFactory = exports.EvalDeltaKeyValue = exports.EvalDelta = exports.ErrorResponse = exports.BoxesResponse = exports.BoxReference = exports.BoxDescriptor = exports.Box = exports.BlockUpgradeVote = exports.BlockUpgradeState = exports.BlockRewards = exports.BlockHeadersResponse = exports.Block = exports.AssetsResponse = exports.AssetResponse = exports.AssetParams = exports.AssetHoldingsResponse = exports.AssetHolding = exports.AssetBalancesResponse = exports.Asset = exports.ApplicationsResponse = exports.ApplicationStateSchema = exports.ApplicationResponse = exports.ApplicationParams = exports.ApplicationLogsResponse = exports.ApplicationLogData = exports.ApplicationLocalStatesResponse = exports.ApplicationLocalState = exports.Application = exports.AccountsResponse = exports.AccountStateDelta = exports.AccountResponse = exports.AccountParticipation = exports.Account = void 0;
exports.TransactionsResponse = exports.TransactionStateProof = exports.TransactionSignaturePQsig = exports.TransactionSignatureMultisigSubsignature = exports.TransactionSignatureMultisig = exports.TransactionSignatureLogicsig = exports.TransactionSignature = exports.TransactionResponse = exports.TransactionPayment = exports.TransactionKeyreg = exports.TransactionHeartbeat = exports.TransactionAssetTransfer = exports.TransactionAssetFreeze = exports.TransactionAssetConfig = exports.TransactionApplication = exports.Transaction = exports.TealValue = exports.TealKeyValue = exports.StateSchema = void 0;
...
class Account {
    ...
    constructor({ address, amount, amountWithoutPendingRewards, minBalance, pendingRewards, rewards, round, status, totalAppsOptedIn, totalAssetsOptedIn, totalBoxBytes, totalBoxes, totalCreatedApps, totalCreatedAssets, appsLocalState, appsTotalExtraPages, appsTotalSchema, assets, authAddr, closedAtRound, createdApps, createdAssets, createdAtRound, deleted, incentiveEligible, lastHeartbeat, lastProposed, participation, rewardBase, sigType, }) {
        ...
        this.minBalance = (0, utils_js_1.ensureSafeInteger)(minBalance);
        ...
        this.totalBoxBytes = (0, utils_js_1.ensureSafeInteger)(totalBoxBytes);
        this.totalBoxes = (0, utils_js_1.ensureSafeInteger)(totalBoxes);
        ...
        this.closedAtRound =
            typeof closedAtRound === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureBigInt)(closedAtRound);
        this.createdApps = createdApps;
        this.createdAssets = createdAssets;
        this.createdAtRound =
            typeof createdAtRound === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureBigInt)(createdAtRound);
    ...
    constructor({ id, params, createdAtRound, deleted, deletedAtRound, }) {
        ...
        this.deletedAtRound =
            typeof deletedAtRound === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureBigInt)(deletedAtRound);
    }
    // eslint-disable-next-line class-methods-use-this
    getEncodingSchema() {
    ...
    constructor({ id, schema, closedOutAtRound, deleted, keyValue, optedInAtRound, }) {
        ...
        this.closedOutAtRound =
            typeof closedOutAtRound === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureBigInt)(closedOutAtRound);
        this.deleted = deleted;
        this.keyValue = keyValue;
        this.optedInAtRound =
            typeof optedInAtRound === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureBigInt)(optedInAtRound);
    }
    // eslint-disable-next-line class-methods-use-this
    getEncodingSchema() {
    ...
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            ...
            this.encodingSchemaValue.pushEntries({
                ...
                valueSchema: new index_js_1.ArraySchema(ApplicationLocalState.encodingSchema),
                omitEmpty: true,
            }, {
                key: 'current-round',
                valueSchema: new index_js_1.Uint64Schema(),
...
class ApplicationLogsResponse {
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            ...
            this.encodingSchemaValue.pushEntries({
                ...
                key: 'log-data',
                valueSchema: new index_js_1.OptionalSchema(new index_js_1.ArraySchema(ApplicationLogData.encodingSchema)),
                omitEmpty: true,
            }, {
                key: 'next-token',
                valueSchema: new index_js_1.OptionalSchema(new index_js_1.StringSchema()),
    ...
    constructor({ applicationId, currentRound, logData, nextToken, }) {
        this.applicationId = (0, utils_js_1.ensureBigInt)(applicationId);
        this.currentRound = (0, utils_js_1.ensureBigInt)(currentRound);
    ...
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            ...
            this.encodingSchemaValue.pushEntries({
                ...
                key: 'application',
                valueSchema: new index_js_1.OptionalSchema(Application.encodingSchema),
                omitEmpty: true,
            });
        }
        return this.encodingSchemaValue;
    ...
    constructor({ index, params, createdAtRound, deleted, destroyedAtRound, }) {
        ...
        this.destroyedAtRound =
            typeof destroyedAtRound === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureBigInt)(destroyedAtRound);
    }
    // eslint-disable-next-line class-methods-use-this
    getEncodingSchema() {
...
class AssetBalancesResponse {
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            ...
            this.encodingSchemaValue.pushEntries({
                key: 'balances',
                valueSchema: new index_js_1.ArraySchema(MiniAssetHolding.encodingSchema),
                omitEmpty: true,
            }, {
                key: 'current-round',
                valueSchema: new index_js_1.Uint64Schema(),
    ...
    constructor({ amount, assetId, isFrozen, deleted, optedInAtRound, optedOutAtRound, }) {
        ...
        this.optedOutAtRound =
            typeof optedOutAtRound === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureBigInt)(optedOutAtRound);
    }
    // eslint-disable-next-line class-methods-use-this
    getEncodingSchema() {
...
class AssetHoldingsResponse {
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            ...
            this.encodingSchemaValue.pushEntries({
                key: 'assets',
                valueSchema: new index_js_1.ArraySchema(AssetHolding.encodingSchema),
                omitEmpty: true,
            }, {
                key: 'current-round',
                valueSchema: new index_js_1.Uint64Schema(),
...
class AssetsResponse {
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            ...
            this.encodingSchemaValue.pushEntries({
                key: 'assets',
                valueSchema: new index_js_1.ArraySchema(Asset.encodingSchema),
                omitEmpty: true,
            }, {
                key: 'current-round',
                valueSchema: new index_js_1.Uint64Schema(),
...
class Block {
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            ...
            this.encodingSchemaValue.pushEntries({
                ...
                valueSchema: new index_js_1.ByteArraySchema(),
                omitEmpty: true,
            }, { key: 'genesis-id', valueSchema: new index_js_1.StringSchema(), omitEmpty: true }, {
                key: 'previous-block-hash',
                valueSchema: new index_js_1.ByteArraySchema(),
                omitEmpty: true,
            }, { key: 'round', valueSchema: new index_js_1.Uint64Schema(), omitEmpty: true }, { key: 'seed', valueSchema: new index_js_1.ByteArraySchema(), omitEmpty: true }, { key: 'timestamp', valueSchema: new index_js_1.Uint64Schema(), omitEmpty: true }, {
                ...
                valueSchema: new index_js_1.OptionalSchema(ParticipationUpdates.encodingSchema),
                omitEmpty: true,
            }, {
                ...
                key: 'rewards',
                valueSchema: new index_js_1.OptionalSchema(BlockRewards.encodingSchema),
                omitEmpty: true,
            }, {
                key: 'state-proof-tracking',
                valueSchema: new index_js_1.OptionalSchema(new index_js_1.ArraySchema(StateProofTracking.encodingSchema)),
                omitEmpty: true,
            }, {
                key: 'transactions',
                valueSchema: new index_js_1.OptionalSchema(new index_js_1.ArraySchema(Transaction.encodingSchema)),
                omitEmpty: true,
            }, {
                ...
                key: 'upgrade-state',
                valueSchema: new index_js_1.OptionalSchema(BlockUpgradeState.encodingSchema),
                omitEmpty: true,
            }, {
                key: 'upgrade-vote',
                valueSchema: new index_js_1.OptionalSchema(BlockUpgradeVote.encodingSchema),
                omitEmpty: true,
            });
        }
        return this.encodingSchemaValue;
     ...
     */
    constructor({ genesisHash, genesisId, previousBlockHash, round, seed, timestamp, transactionsRoot, transactionsRootSha256, bonus, congestionTax, feesCollected, load, participationUpdates, previousBlockHash512, proposer, proposerPayout, rewards, stateProofTracking, transactions, transactionsRootSha512, txnCounter, upgradeState, upgradeVote, }) {
        this.genesisHash =
        ...
        this.previousBlockHash =
            typeof previousBlockHash === 'string'
                ? (0, binarydata_js_1.base64ToBytes)(previousBlockHash)
                : previousBlockHash;
        this.round = (0, utils_js_1.ensureBigInt)(round);
        this.seed = typeof seed === 'string' ? (0, binarydata_js_1.base64ToBytes)(seed) : seed;
        this.timestamp = (0, utils_js_1.ensureSafeInteger)(timestamp);
        this.transactionsRoot =
            typeof transactionsRoot === 'string'
                ? (0, binarydata_js_1.base64ToBytes)(transactionsRoot)
                : transactionsRoot;
        this.transactionsRootSha256 =
            typeof transactionsRootSha256 === 'string'
                ? (0, binarydata_js_1.base64ToBytes)(transactionsRootSha256)
                : transactionsRootSha256;
        this.bonus =
            typeof bonus === 'undefined' ? undefined : (0, utils_js_1.ensureSafeInteger)(bonus);
        this.congestionTax =
            typeof congestionTax === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureSafeInteger)(congestionTax);
        this.feesCollected =
            typeof feesCollected === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureSafeInteger)(feesCollected);
        this.load =
            typeof load === 'undefined' ? undefined : (0, utils_js_1.ensureSafeInteger)(load);
        this.participationUpdates = participationUpdates;
        this.previousBlockHash512 =
            typeof previousBlockHash512 === 'string'
                ? (0, binarydata_js_1.base64ToBytes)(previousBlockHash512)
                : previousBlockHash512;
        this.proposer =
            typeof proposer === 'string' ? address_js_1.Address.fromString(proposer) : proposer;
        this.proposerPayout =
            typeof proposerPayout === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureSafeInteger)(proposerPayout);
        this.rewards = rewards;
        this.stateProofTracking = stateProofTracking;
        this.transactions = transactions;
        this.transactionsRootSha512 =
            typeof transactionsRootSha512 === 'string'
                ? (0, binarydata_js_1.base64ToBytes)(transactionsRootSha512)
                : transactionsRootSha512;
        this.txnCounter =
            typeof txnCounter === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureSafeInteger)(txnCounter);
...
class BlockHeadersResponse {
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            ...
            this.encodingSchemaValue.pushEntries({
                key: 'blocks',
                valueSchema: new index_js_1.ArraySchema(Block.encodingSchema),
                omitEmpty: true,
            }, {
                key: 'current-round',
                valueSchema: new index_js_1.Uint64Schema(),
...
exports.BlockHeadersResponse = BlockHeadersResponse;
/**
...
class BlockRewards {
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            this.encodingSchemaValue = new index_js_1.NamedMapSchema([]);
            this.encodingSchemaValue.pushEntries({ key: 'fee-sink', valueSchema: new index_js_1.StringSchema(), omitEmpty: true }, {
    ...
    constructor({ feeSink, rewardsCalculationRound, rewardsLevel, rewardsPool, rewardsRate, rewardsResidue, }) {
        ...
        this.rewardsCalculationRound = (0, utils_js_1.ensureBigInt)(rewardsCalculationRound);
        this.rewardsLevel = (0, utils_js_1.ensureBigInt)(rewardsLevel);
        this.rewardsPool = rewardsPool;
        this.rewardsRate = (0, utils_js_1.ensureBigInt)(rewardsRate);
        this.rewardsResidue = (0, utils_js_1.ensureBigInt)(rewardsResidue);
    }
    // eslint-disable-next-line class-methods-use-this
    getEncodingSchema() {
    ...
    constructor({ currentProtocol, nextProtocol, nextProtocolApprovals, nextProtocolSwitchOn, nextProtocolVoteBefore, }) {
        ...
        this.nextProtocolApprovals =
            typeof nextProtocolApprovals === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureSafeInteger)(nextProtocolApprovals);
        this.nextProtocolSwitchOn =
            typeof nextProtocolSwitchOn === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureBigInt)(nextProtocolSwitchOn);
        this.nextProtocolVoteBefore =
            typeof nextProtocolVoteBefore === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureBigInt)(nextProtocolVoteBefore);
    }
    // eslint-disable-next-line class-methods-use-this
    getEncodingSchema() {
...
class BoxDescriptor {
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            this.encodingSchemaValue = new index_js_1.NamedMapSchema([]);
            this.encodingSchemaValue.pushEntries({ key: 'name', valueSchema: new index_js_1.ByteArraySchema(), omitEmpty: true }, {
                key: 'value',
                valueSchema: new index_js_1.OptionalSchema(new index_js_1.ByteArraySchema()),
                omitEmpty: true,
            });
...
class BoxReference {
    ...
    constructor({ app, name, }) {
        this.app = (0, utils_js_1.ensureSafeInteger)(app);
        this.name = typeof name === 'string' ? (0, binarydata_js_1.base64ToBytes)(name) : name;
    }
    // eslint-disable-next-line class-methods-use-this
    getEncodingSchema() {
...
class BoxesResponse {
     ...
     * @param round - The round for which this information is relevant.
     */
    constructor({ applicationId, boxes, nextToken, round, }) {
        this.applicationId = (0, utils_js_1.ensureBigInt)(applicationId);
        this.boxes = boxes;
        this.nextToken = nextToken;
        this.round =
            typeof round === 'undefined' ? undefined : (0, utils_js_1.ensureSafeInteger)(round);
    }
    // eslint-disable-next-line class-methods-use-this
    getEncodingSchema() {
...
class HashFactory {
    ...
    constructor({ hashType }) {
        this.hashType =
            typeof hashType === 'undefined' ? undefined : (0, utils_js_1.ensureSafeInteger)(hashType);
    }
    // eslint-disable-next-line class-methods-use-this
    getEncodingSchema() {
...
class HbProofFields {
    ...
    constructor({ hbPk, hbPk1sig, hbPk2, hbPk2sig, hbSig, }) {
        this.hbPk = typeof hbPk === 'string' ? (0, binarydata_js_1.base64ToBytes)(hbPk) : hbPk;
        this.hbPk1sig =
            typeof hbPk1sig === 'string' ? (0, binarydata_js_1.base64ToBytes)(hbPk1sig) : hbPk1sig;
        this.hbPk2 = typeof hbPk2 === 'string' ? (0, binarydata_js_1.base64ToBytes)(hbPk2) : hbPk2;
        this.hbPk2sig =
            typeof hbPk2sig === 'string' ? (0, binarydata_js_1.base64ToBytes)(hbPk2sig) : hbPk2sig;
        this.hbSig = typeof hbSig === 'string' ? (0, binarydata_js_1.base64ToBytes)(hbSig) : hbSig;
    }
    // eslint-disable-next-line class-methods-use-this
    getEncodingSchema() {
...
exports.HbProofFields = HbProofFields;
/**
    ...
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            ...
            this.encodingSchemaValue.pushEntries({
                ...
                valueSchema: new index_js_1.BooleanSchema(),
                omitEmpty: true,
            }, { key: 'message', valueSchema: new index_js_1.StringSchema(), omitEmpty: true }, { key: 'round', valueSchema: new index_js_1.Uint64Schema(), omitEmpty: true }, { key: 'version', valueSchema: new index_js_1.StringSchema(), omitEmpty: true }, {
                key: 'data',
                valueSchema: new index_js_1.OptionalSchema(untypedmodel_js_1.UntypedValue.encodingSchema),
                omitEmpty: true,
            }, {
...
class HoldingRef {
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            this.encodingSchemaValue = new index_js_1.NamedMapSchema([]);
            this.encodingSchemaValue.pushEntries({ key: 'address', valueSchema: new index_js_1.StringSchema(), omitEmpty: true }, { key: 'asset', valueSchema: new index_js_1.Uint64Schema(), omitEmpty: true });
        }
        return this.encodingSchemaValue;
    }
    /**
    ...
    constructor({ address, asset, }) {
        this.address =
            typeof address === 'string' ? address_js_1.Address.fromString(address) : address;
        this.asset = (0, utils_js_1.ensureSafeInteger)(asset);
    }
    // eslint-disable-next-line class-methods-use-this
    getEncodingSchema() {
    ...
    constructor({ blockHeadersCommitment, firstAttestedRound, latestAttestedRound, lnProvenWeight, votersCommitment, }) {
        ...
        this.firstAttestedRound =
            typeof firstAttestedRound === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureBigInt)(firstAttestedRound);
        this.latestAttestedRound =
            typeof latestAttestedRound === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureBigInt)(latestAttestedRound);
        this.lnProvenWeight =
            typeof lnProvenWeight === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureBigInt)(lnProvenWeight);
...
class LocalsRef {
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            this.encodingSchemaValue = new index_js_1.NamedMapSchema([]);
            this.encodingSchemaValue.pushEntries({ key: 'address', valueSchema: new index_js_1.StringSchema(), omitEmpty: true }, { key: 'app', valueSchema: new index_js_1.Uint64Schema(), omitEmpty: true });
        }
        return this.encodingSchemaValue;
    }
    /**
...
class MerkleArrayProof {
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            ...
            this.encodingSchemaValue.pushEntries({
                key: 'hash-factory',
                valueSchema: new index_js_1.OptionalSchema(HashFactory.encodingSchema),
                omitEmpty: true,
            }, {
                key: 'path',
    ...
    constructor({ hashFactory, path, treeDepth, }) {
        ...
        this.treeDepth =
            typeof treeDepth === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureSafeInteger)(treeDepth);
    }
    // eslint-disable-next-line class-methods-use-this
    getEncodingSchema() {
...
class MiniAssetHolding {
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            this.encodingSchemaValue = new index_js_1.NamedMapSchema([]);
            this.encodingSchemaValue.pushEntries({ key: 'address', valueSchema: new index_js_1.StringSchema(), omitEmpty: true }, { key: 'amount', valueSchema: new index_js_1.Uint64Schema(), omitEmpty: true }, { key: 'is-frozen', valueSchema: new index_js_1.BooleanSchema(), omitEmpty: true }, {
                key: 'deleted',
                valueSchema: new index_js_1.OptionalSchema(new index_js_1.BooleanSchema()),
                omitEmpty: true,
            }, {
    ...
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            ...
            this.encodingSchemaValue.pushEntries({
                ...
                key: 'box',
                valueSchema: new index_js_1.OptionalSchema(BoxReference.encodingSchema),
                omitEmpty: true,
            }, {
                key: 'holding',
                valueSchema: new index_js_1.OptionalSchema(HoldingRef.encodingSchema),
                omitEmpty: true,
            }, {
                key: 'local',
                valueSchema: new index_js_1.OptionalSchema(LocalsRef.encodingSchema),
                omitEmpty: true,
            });
        }
        return this.encodingSchemaValue;
    ...
    constructor({ address, applicationId, assetId, box, holding, local, }) {
        ...
        this.applicationId =
            typeof applicationId === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureSafeInteger)(applicationId);
        this.assetId =
            typeof assetId === 'undefined' ? undefined : (0, utils_js_1.ensureSafeInteger)(assetId);
        this.box = box;
...
class StateProofFields {
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            ...
            this.encodingSchemaValue.pushEntries({
                key: 'part-proofs',
                valueSchema: new index_js_1.OptionalSchema(MerkleArrayProof.encodingSchema),
                omitEmpty: true,
            }, {
                ...
                key: 'reveals',
                valueSchema: new index_js_1.OptionalSchema(new index_js_1.ArraySchema(StateProofReveal.encodingSchema)),
                omitEmpty: true,
            }, {
                key: 'salt-version',
                valueSchema: new index_js_1.OptionalSchema(new index_js_1.Uint64Schema()),
    ...
    constructor({ partProofs, positionsToReveal, reveals, saltVersion, sigCommit, sigProofs, signedWeight, }) {
        ...
        this.positionsToReveal =
            typeof positionsToReveal === 'undefined'
                ? undefined
                : positionsToReveal.map(utils_js_1.ensureBigInt);
        this.reveals = reveals;
        this.saltVersion =
            typeof saltVersion === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureSafeInteger)(saltVersion);
        this.sigCommit =
            typeof sigCommit === 'string' ? (0, binarydata_js_1.base64ToBytes)(sigCommit) : sigCommit;
        this.sigProofs = sigProofs;
        this.signedWeight =
            typeof signedWeight === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureBigInt)(signedWeight);
    }
    // eslint-disable-next-line class-methods-use-this
    getEncodingSchema() {
...
class StateProofParticipant {
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            ...
            this.encodingSchemaValue.pushEntries({
                key: 'verifier',
                valueSchema: new index_js_1.OptionalSchema(StateProofVerifier.encodingSchema),
                omitEmpty: true,
            }, {
                key: 'weight',
                valueSchema: new index_js_1.OptionalSchema(new index_js_1.Uint64Schema()),
    ...
    constructor({ verifier, weight, }) {
        ...
        this.weight =
            typeof weight === 'undefined' ? undefined : (0, utils_js_1.ensureBigInt)(weight);
    }
    // eslint-disable-next-line class-methods-use-this
    getEncodingSchema() {
...
class StateProofReveal {
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            ...
            this.encodingSchemaValue.pushEntries({
                key: 'participant',
                valueSchema: new index_js_1.OptionalSchema(StateProofParticipant.encodingSchema),
                omitEmpty: true,
            }, {
                key: 'position',
                valueSchema: new index_js_1.OptionalSchema(new index_js_1.Uint64Schema()),
                ...
                key: 'sig-slot',
                valueSchema: new index_js_1.OptionalSchema(StateProofSigSlot.encodingSchema),
                omitEmpty: true,
            });
        }
        return this.encodingSchemaValue;
    ...
    constructor({ participant, position, sigSlot, }) {
        ...
        this.position =
            typeof position === 'undefined' ? undefined : (0, utils_js_1.ensureBigInt)(position);
    ...
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            ...
            this.encodingSchemaValue.pushEntries({
                ...
                key: 'signature',
                valueSchema: new index_js_1.OptionalSchema(StateProofSignature.encodingSchema),
                omitEmpty: true,
            });
        }
        return this.encodingSchemaValue;
    ...
    constructor({ lowerSigWeight, signature, }) {
        this.lowerSigWeight =
            typeof lowerSigWeight === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureBigInt)(lowerSigWeight);
    ...
    constructor({ falconSignature, merkleArrayIndex, proof, verifyingKey, }) {
        this.falconSignature =
            typeof falconSignature === 'string'
                ? (0, binarydata_js_1.base64ToBytes)(falconSignature)
                : falconSignature;
        this.merkleArrayIndex =
            typeof merkleArrayIndex === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureSafeInteger)(merkleArrayIndex);
        this.proof = proof;
        this.verifyingKey =
            typeof verifyingKey === 'string'
                ? (0, binarydata_js_1.base64ToBytes)(verifyingKey)
                : verifyingKey;
    }
    // eslint-disable-next-line class-methods-use-this
    getEncodingSchema() {
...
class StateProofTracking {
    ...
    constructor({ nextRound, onlineTotalWeight, type, votersCommitment, }) {
        this.nextRound =
            typeof nextRound === 'undefined' ? undefined : (0, utils_js_1.ensureBigInt)(nextRound);
        this.onlineTotalWeight =
            typeof onlineTotalWeight === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureBigInt)(onlineTotalWeight);
        this.type =
            typeof type === 'undefined' ? undefined : (0, utils_js_1.ensureSafeInteger)(type);
        this.votersCommitment =
            typeof votersCommitment === 'string'
                ? (0, binarydata_js_1.base64ToBytes)(votersCommitment)
                : votersCommitment;
...
class StateProofVerifier {
    ...
    constructor({ commitment, keyLifetime, }) {
        this.commitment =
            typeof commitment === 'string' ? (0, binarydata_js_1.base64ToBytes)(commitment) : commitment;
        this.keyLifetime =
            typeof keyLifetime === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureBigInt)(keyLifetime);
    }
    // eslint-disable-next-line class-methods-use-this
    getEncodingSchema() {
...
class Transaction {
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            this.encodingSchemaValue = new index_js_1.NamedMapSchema([]);
            this.encodingSchemaValue.pushEntries({ key: 'fee', valueSchema: new index_js_1.Uint64Schema(), omitEmpty: true }, {
                key: 'first-valid',
                valueSchema: new index_js_1.Uint64Schema(),
                omitEmpty: true,
            }, { key: 'last-valid', valueSchema: new index_js_1.Uint64Schema(), omitEmpty: true }, { key: 'sender', valueSchema: new index_js_1.StringSchema(), omitEmpty: true }, {
                key: 'application-transaction',
                valueSchema: new index_js_1.OptionalSchema(TransactionApplication.encodingSchema),
                omitEmpty: true,
            }, {
                key: 'asset-config-transaction',
                valueSchema: new index_js_1.OptionalSchema(TransactionAssetConfig.encodingSchema),
                omitEmpty: true,
            }, {
                key: 'asset-freeze-transaction',
                valueSchema: new index_js_1.OptionalSchema(TransactionAssetFreeze.encodingSchema),
                omitEmpty: true,
            }, {
                key: 'asset-transfer-transaction',
                valueSchema: new index_js_1.OptionalSchema(TransactionAssetTransfer.encodingSchema),
                omitEmpty: true,
            }, {
                key: 'auth-addr',
                valueSchema: new index_js_1.OptionalSchema(new index_js_1.StringSchema()),
                ...
                valueSchema: new index_js_1.OptionalSchema(TransactionHeartbeat.encodingSchema),
                omitEmpty: true,
            }, {
                key: 'id',
                valueSchema: new index_js_1.OptionalSchema(new index_js_1.StringSchema()),
                ...
                valueSchema: new index_js_1.OptionalSchema(TransactionKeyreg.encodingSchema),
                omitEmpty: true,
            }, {
                key: 'lease',
                valueSchema: new index_js_1.OptionalSchema(new index_js_1.ByteArraySchema()),
                ...
                valueSchema: new index_js_1.OptionalSchema(TransactionPayment.encodingSchema),
                omitEmpty: true,
            }, {
                ...
                key: 'signature',
                valueSchema: new index_js_1.OptionalSchema(TransactionSignature.encodingSchema),
                omitEmpty: true,
            }, {
                key: 'state-proof-transaction',
                valueSchema: new index_js_1.OptionalSchema(TransactionStateProof.encodingSchema),
                omitEmpty: true,
            }, {
                key: 'tx-type',
                valueSchema: new index_js_1.OptionalSchema(new index_js_1.StringSchema()),
    ...
    constructor({ fee, firstValid, lastValid, sender, applicationTransaction, assetConfigTransaction, assetFreezeTransaction, assetTransferTransaction, authAddr, closeRewards, closingAmount, confirmedRound, createdApplicationIndex, createdAssetIndex, genesisHash, genesisId, globalStateDelta, group, heartbeatTransaction, id, innerTxns, intraRoundOffset, keyregTransaction, lease, localStateDelta, logs, note, paymentTransaction, receiverRewards, rekeyTo, roundTime, senderRewards, signature, stateProofTransaction, txType, }) {
        ...
        this.firstValid = (0, utils_js_1.ensureBigInt)(firstValid);
        this.lastValid = (0, utils_js_1.ensureBigInt)(lastValid);
        this.sender = sender;
        ...
        this.createdApplicationIndex =
            typeof createdApplicationIndex === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureBigInt)(createdApplicationIndex);
        this.createdAssetIndex =
            typeof createdAssetIndex === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureBigInt)(createdAssetIndex);
        this.genesisHash =
            typeof genesisHash === 'string'
                ? (0, binarydata_js_1.base64ToBytes)(genesisHash)
                : genesisHash;
        ...
        this.group = typeof group === 'string' ? (0, binarydata_js_1.base64ToBytes)(group) : group;
        ...
        this.intraRoundOffset =
            typeof intraRoundOffset === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureSafeInteger)(intraRoundOffset);
        this.keyregTransaction = keyregTransaction;
        this.lease = typeof lease === 'string' ? (0, binarydata_js_1.base64ToBytes)(lease) : lease;
        this.localStateDelta = localStateDelta;
        this.logs = logs;
        this.note = typeof note === 'string' ? (0, binarydata_js_1.base64ToBytes)(note) : note;
        ...
        this.rekeyTo =
            typeof rekeyTo === 'string' ? address_js_1.Address.fromString(rekeyTo) : rekeyTo;
        this.roundTime =
            typeof roundTime === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureSafeInteger)(roundTime);
        this.senderRewards =
    ...
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            ...
            this.encodingSchemaValue.pushEntries({
                ...
                key: 'access',
                valueSchema: new index_js_1.OptionalSchema(new index_js_1.ArraySchema(ResourceRef.encodingSchema)),
                omitEmpty: true,
            }, {
                key: 'accounts',
                valueSchema: new index_js_1.OptionalSchema(new index_js_1.ArraySchema(new index_js_1.StringSchema())),
                ...
                key: 'global-state-schema',
                valueSchema: new index_js_1.OptionalSchema(StateSchema.encodingSchema),
                omitEmpty: true,
            }, {
                key: 'local-state-schema',
                valueSchema: new index_js_1.OptionalSchema(StateSchema.encodingSchema),
    ...
    constructor({ applicationId, access, accounts, applicationArgs, approvalProgram, boxReferences, clearStateProgram, extraProgramPages, foreignApps, foreignAssets, globalStateSchema, localStateSchema, onCompletion, rejectVersion, }) {
        ...
        this.foreignApps =
            typeof foreignApps === 'undefined'
                ? undefined
                : foreignApps.map(utils_js_1.ensureBigInt);
        this.foreignAssets =
            typeof foreignAssets === 'undefined'
                ? undefined
                : foreignAssets.map(utils_js_1.ensureBigInt);
        this.globalStateSchema = globalStateSchema;
        this.localStateSchema = localStateSchema;
        ...
        this.rejectVersion =
            typeof rejectVersion === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureSafeInteger)(rejectVersion);
    }
    // eslint-disable-next-line class-methods-use-this
    getEncodingSchema() {
...
class TransactionAssetConfig {
    ...
    constructor({ assetId, params, }) {
        this.assetId =
            typeof assetId === 'undefined' ? undefined : (0, utils_js_1.ensureBigInt)(assetId);
        this.params = params;
    }
    // eslint-disable-next-line class-methods-use-this
    getEncodingSchema() {
...
class TransactionAssetFreeze {
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            this.encodingSchemaValue = new index_js_1.NamedMapSchema([]);
            this.encodingSchemaValue.pushEntries({ key: 'address', valueSchema: new index_js_1.StringSchema(), omitEmpty: true }, { key: 'asset-id', valueSchema: new index_js_1.Uint64Schema(), omitEmpty: true }, {
...
class TransactionAssetTransfer {
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            this.encodingSchemaValue = new index_js_1.NamedMapSchema([]);
            this.encodingSchemaValue.pushEntries({ key: 'amount', valueSchema: new index_js_1.Uint64Schema(), omitEmpty: true }, { key: 'asset-id', valueSchema: new index_js_1.Uint64Schema(), omitEmpty: true }, { key: 'receiver', valueSchema: new index_js_1.StringSchema(), omitEmpty: true }, {
                key: 'close-amount',
                valueSchema: new index_js_1.OptionalSchema(new index_js_1.Uint64Schema()),
                omitEmpty: true,
            }, {
    ...
    constructor({ amount, assetId, receiver, closeAmount, closeTo, sender, }) {
        ...
        this.closeAmount =
            typeof closeAmount === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureBigInt)(closeAmount);
...
class TransactionHeartbeat {
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            this.encodingSchemaValue = new index_js_1.NamedMapSchema([]);
            this.encodingSchemaValue.pushEntries({ key: 'hb-address', valueSchema: new index_js_1.StringSchema(), omitEmpty: true }, {
                key: 'hb-key-dilution',
                valueSchema: new index_js_1.Uint64Schema(),
                omitEmpty: true,
            }, {
                ...
                omitEmpty: true,
            }, { key: 'hb-seed', valueSchema: new index_js_1.ByteArraySchema(), omitEmpty: true }, {
                key: 'hb-vote-id',
                valueSchema: new index_js_1.ByteArraySchema(),
                omitEmpty: true,
            }, {
     ...
     */
    constructor({ hbAddress, hbKeyDilution, hbProof, hbSeed, hbVoteId, hbChallengeDiscount, }) {
        this.hbAddress = hbAddress;
        this.hbKeyDilution = (0, utils_js_1.ensureBigInt)(hbKeyDilution);
        this.hbProof = hbProof;
        this.hbSeed = typeof hbSeed === 'string' ? (0, binarydata_js_1.base64ToBytes)(hbSeed) : hbSeed;
        this.hbVoteId =
            typeof hbVoteId === 'string' ? (0, binarydata_js_1.base64ToBytes)(hbVoteId) : hbVoteId;
    ...
    constructor({ nonParticipation, selectionParticipationKey, stateProofKey, voteFirstValid, voteKeyDilution, voteLastValid, voteParticipationKey, }) {
        ...
        this.voteFirstValid =
            typeof voteFirstValid === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureBigInt)(voteFirstValid);
        this.voteKeyDilution =
            typeof voteKeyDilution === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureBigInt)(voteKeyDilution);
        this.voteLastValid =
            typeof voteLastValid === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureBigInt)(voteLastValid);
        this.voteParticipationKey =
            typeof voteParticipationKey === 'string'
                ? (0, binarydata_js_1.base64ToBytes)(voteParticipationKey)
                : voteParticipationKey;
...
class TransactionPayment {
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            this.encodingSchemaValue = new index_js_1.NamedMapSchema([]);
            this.encodingSchemaValue.pushEntries({ key: 'amount', valueSchema: new index_js_1.Uint64Schema(), omitEmpty: true }, { key: 'receiver', valueSchema: new index_js_1.StringSchema(), omitEmpty: true }, {
                key: 'close-amount',
                valueSchema: new index_js_1.OptionalSchema(new index_js_1.Uint64Schema()),
                omitEmpty: true,
            }, {
...
class TransactionSignature {
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            ...
            this.encodingSchemaValue.pushEntries({
                key: 'logicsig',
                valueSchema: new index_js_1.OptionalSchema(TransactionSignatureLogicsig.encodingSchema),
                omitEmpty: true,
            }, {
                key: 'multisig',
                valueSchema: new index_js_1.OptionalSchema(TransactionSignatureMultisig.encodingSchema),
                omitEmpty: true,
            }, {
                key: 'pqsig',
                valueSchema: new index_js_1.OptionalSchema(TransactionSignaturePQsig.encodingSchema),
                omitEmpty: true,
            }, {
                key: 'sig',
                valueSchema: new index_js_1.OptionalSchema(new index_js_1.ByteArraySchema()),
     ...
     */
    constructor({ logicsig, multisig, pqsig, sig, }) {
        this.logicsig = logicsig;
        this.multisig = multisig;
        this.pqsig = pqsig;
        this.sig = typeof sig === 'string' ? (0, binarydata_js_1.base64ToBytes)(sig) : sig;
    }
    // eslint-disable-next-line class-methods-use-this
    getEncodingSchema() {
    ...
    static fromEncodingData(data) {
        ...
        return new TransactionSignature({
            ...
            multisig: typeof data.get('multisig') !== 'undefined'
                ...
                : undefined,
            pqsig: typeof data.get('pqsig') !== 'undefined'
...
class TransactionSignatureLogicsig {
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            this.encodingSchemaValue = new index_js_1.NamedMapSchema([]);
            this.encodingSchemaValue.pushEntries({ key: 'logic', valueSchema: new index_js_1.ByteArraySchema(), omitEmpty: true }, {
                key: 'args',
                valueSchema: new index_js_1.OptionalSchema(new index_js_1.ArraySchema(new index_js_1.ByteArraySchema())),
                omitEmpty: true,
            }, {
     ...
     */
    constructor({ logic, args, logicMultisigSignature, multisigSignature, pqsig, signature, }) {
        this.logic = typeof logic === 'string' ? (0, binarydata_js_1.base64ToBytes)(logic) : logic;
        this.args = args;
        this.logicMultisigSignature = logicMultisigSignature;
        this.multisigSignature = multisigSignature;
        this.pqsig = pqsig;
        this.signature =
            typeof signature === 'string' ? (0, binarydata_js_1.base64ToBytes)(signature) : signature;
    }
    // eslint-disable-next-line class-methods-use-this
    getEncodingSchema() {
...
class TransactionSignatureMultisig {
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            ...
            this.encodingSchemaValue.pushEntries({
                key: 'subsignature',
                valueSchema: new index_js_1.OptionalSchema(new index_js_1.ArraySchema(TransactionSignatureMultisigSubsignature.encodingSchema)),
                omitEmpty: true,
            }, {
                key: 'threshold',
                valueSchema: new index_js_1.OptionalSchema(new index_js_1.Uint64Schema()),
    ...
    constructor({ subsignature, threshold, version, }) {
        ...
        this.threshold =
            typeof threshold === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureSafeInteger)(threshold);
        this.version =
            typeof version === 'undefined' ? undefined : (0, utils_js_1.ensureSafeInteger)(version);
    }
    // eslint-disable-next-line class-methods-use-this
...
class TransactionSignatureMultisigSubsignature {
    ...
    constructor({ publicKey, signature, }) {
        this.publicKey =
            typeof publicKey === 'string' ? (0, binarydata_js_1.base64ToBytes)(publicKey) : publicKey;
        this.signature =
            typeof signature === 'string' ? (0, binarydata_js_1.base64ToBytes)(signature) : signature;
    }
    // eslint-disable-next-line class-methods-use-this
 ...
 * data/transactions/pqsig.go : PQSig
 */
class TransactionSignaturePQsig {
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            this.encodingSchemaValue = new index_js_1.NamedMapSchema([]);
            this.encodingSchemaValue.pushEntries({
                ...
                valueSchema: new index_js_1.ByteArraySchema(),
                omitEmpty: true,
            }, { key: 'scheme', valueSchema: new index_js_1.StringSchema(), omitEmpty: true }, {
                key: 'signature',
                valueSchema: new index_js_1.ByteArraySchema(),
                omitEmpty: true,
            }, {
     ...
     * point
     */
    constructor({ publicKey, scheme, signature, salt, }) {
        this.publicKey =
            typeof publicKey === 'string' ? (0, binarydata_js_1.base64ToBytes)(publicKey) : publicKey;
        this.scheme = scheme;
        this.signature =
            typeof signature === 'string' ? (0, binarydata_js_1.base64ToBytes)(signature) : signature;
        this.salt =
            typeof salt === 'undefined' ? undefined : (0, utils_js_1.ensureSafeInteger)(salt);
    }
    // eslint-disable-next-line class-methods-use-this
    getEncodingSchema() {
...
exports.TransactionSignaturePQsig = TransactionSignaturePQsig;
/**
...
class TransactionStateProof {
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            ...
            this.encodingSchemaValue.pushEntries({
                key: 'message',
                valueSchema: new index_js_1.OptionalSchema(IndexerStateProofMessage.encodingSchema),
                omitEmpty: true,
            }, {
                key: 'state-proof',
                valueSchema: new index_js_1.OptionalSchema(StateProofFields.encodingSchema),
                omitEmpty: true,
            }, {
    ...
    constructor({ message, stateProof, stateProofType, }) {
        ...
        this.stateProofType =
            typeof stateProofType === 'undefined'
                ? undefined
                : (0, utils_js_1.ensureSafeInteger)(stateProofType);
    }
    // eslint-disable-next-line class-methods-use-this
    getEncodingSchema() {
    ...
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            ...
            this.encodingSchemaValue.pushEntries({
                ...
                key: 'transactions',
                valueSchema: new index_js_1.ArraySchema(Transaction.encodingSchema),
                omitEmpty: true,
            }, {
                key: 'next-token',
                valueSchema: new index_js_1.OptionalSchema(new index_js_1.StringSchema()),
