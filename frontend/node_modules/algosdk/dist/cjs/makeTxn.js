...
exports.makeApplicationNoOpTxnFromObject = exports.makeApplicationClearStateTxnFromObject = exports.makeApplicationCloseOutTxnFromObject = exports.makeApplicationOptInTxnFromObject = exports.makeApplicationDeleteTxnFromObject = exports.makeApplicationUpdateTxnFromObject = exports.makeApplicationCreateTxnFromObject = exports.makeApplicationCallTxnFromObject = exports.makeAssetTransferTxnWithSuggestedParamsFromObject = exports.makeAssetFreezeTxnWithSuggestedParamsFromObject = exports.makeAssetDestroyTxnWithSuggestedParamsFromObject = exports.makeAssetConfigTxnWithSuggestedParamsFromObject = exports.makeAssetCreateTxnWithSuggestedParamsFromObject = exports.makeBaseAssetConfigTxn = exports.makeKeyRegistrationTxnWithSuggestedParamsFromObject = exports.makePaymentTxnWithSuggestedParamsFromObject = void 0;
...
function makePaymentTxnWithSuggestedParamsFromObject({ sender, receiver, amount, closeRemainderTo, suggestedParams, note, lease, rekeyTo, }) {
    return new transaction_js_1.Transaction({
        type: base_js_1.TransactionType.pay,
        sender,
        note,
        lease,
        rekeyTo,
...
function makeKeyRegistrationTxnWithSuggestedParamsFromObject({ sender, voteKey, selectionKey, stateProofKey, voteFirst, voteLast, voteKeyDilution, nonParticipation, suggestedParams, note, lease, rekeyTo, }) {
    return new transaction_js_1.Transaction({
        type: base_js_1.TransactionType.keyreg,
        sender,
        note,
        lease,
        rekeyTo,
...
function makeBaseAssetConfigTxn({ sender, assetIndex, total, decimals, defaultFrozen, manager, reserve, freeze, clawback, unitName, assetName, assetURL, assetMetadataHash, note, lease, rekeyTo, suggestedParams, }) {
    return new transaction_js_1.Transaction({
        type: base_js_1.TransactionType.acfg,
        sender,
        note,
        lease,
        rekeyTo,
...
exports.makeBaseAssetConfigTxn = makeBaseAssetConfigTxn;
/**
...
function makeAssetFreezeTxnWithSuggestedParamsFromObject({ sender, assetIndex, freezeTarget, frozen, suggestedParams, note, lease, rekeyTo, }) {
    return new transaction_js_1.Transaction({
        type: base_js_1.TransactionType.afrz,
        sender,
        note,
        lease,
        rekeyTo,
...
function makeAssetTransferTxnWithSuggestedParamsFromObject({ sender, receiver, amount, closeRemainderTo, assetSender, note, assetIndex, suggestedParams, rekeyTo, lease, }) {
    ...
    return new transaction_js_1.Transaction({
        type: base_js_1.TransactionType.axfer,
        sender,
        note,
        lease,
        rekeyTo,
...
function makeApplicationCallTxnFromObject({ sender, appIndex, onComplete, appArgs, accounts, foreignApps, foreignAssets, boxes, convertToAccess, holdings, locals, access, approvalProgram, clearProgram, numLocalInts, numLocalByteSlices, numGlobalInts, numGlobalByteSlices, extraPages, rejectVersion, note, lease, rekeyTo, suggestedParams, }) {
    ...
    let access2 = access;
    if (convertToAccess) {
        access2 = (0, appAccess_js_1.foreignArraysToResourceReferences)({
            appIndex,
            accounts,
            foreignApps,
            foreignAssets,
    ...
    return new transaction_js_1.Transaction({
        type: base_js_1.TransactionType.appl,
        sender,
        note,
        lease,
        rekeyTo,
 ...
 */
function makeApplicationUpdateTxnFromObject({ sender, appIndex, appArgs, accounts, foreignApps, foreignAssets, boxes, convertToAccess, holdings, locals, access, approvalProgram, clearProgram, numGlobalInts, numGlobalByteSlices, extraPages, note, lease, rekeyTo, suggestedParams, }) {
    if (!appIndex) {
    ...
    return makeApplicationCallTxnFromObject({
        sender,
        appIndex,
        onComplete: base_js_1.OnApplicationComplete.UpdateApplicationOC,
        appArgs,
        accounts,
        foreignApps,
        foreignAssets,
...
function makeApplicationDeleteTxnFromObject({ sender, appIndex, appArgs, accounts, foreignApps, foreignAssets, boxes, convertToAccess, holdings, locals, access, note, lease, rekeyTo, suggestedParams, }) {
    ...
    return makeApplicationCallTxnFromObject({
        sender,
        appIndex,
        onComplete: base_js_1.OnApplicationComplete.DeleteApplicationOC,
        appArgs,
        accounts,
        foreignApps,
        foreignAssets,
...
function makeApplicationOptInTxnFromObject({ sender, appIndex, appArgs, accounts, foreignApps, foreignAssets, boxes, convertToAccess, holdings, locals, access, note, lease, rekeyTo, suggestedParams, }) {
    ...
    return makeApplicationCallTxnFromObject({
        sender,
        appIndex,
        onComplete: base_js_1.OnApplicationComplete.OptInOC,
        appArgs,
        accounts,
        foreignApps,
        foreignAssets,
...
function makeApplicationCloseOutTxnFromObject({ sender, appIndex, appArgs, accounts, foreignApps, foreignAssets, boxes, convertToAccess, holdings, locals, access, note, lease, rekeyTo, suggestedParams, }) {
    ...
    return makeApplicationCallTxnFromObject({
        sender,
        appIndex,
        onComplete: base_js_1.OnApplicationComplete.CloseOutOC,
        appArgs,
        accounts,
        foreignApps,
        foreignAssets,
...
function makeApplicationClearStateTxnFromObject({ sender, appIndex, appArgs, accounts, foreignApps, foreignAssets, boxes, convertToAccess, holdings, locals, access, note, lease, rekeyTo, suggestedParams, }) {
    ...
    return makeApplicationCallTxnFromObject({
        sender,
        appIndex,
        onComplete: base_js_1.OnApplicationComplete.ClearStateOC,
        appArgs,
        accounts,
        foreignApps,
        foreignAssets,
...
function makeApplicationNoOpTxnFromObject({ sender, appIndex, appArgs, accounts, foreignApps, foreignAssets, boxes, convertToAccess, holdings, locals, access, note, lease, rekeyTo, suggestedParams, }) {
    ...
    return makeApplicationCallTxnFromObject({
        sender,
        appIndex,
        onComplete: base_js_1.OnApplicationComplete.NoOpOC,
        appArgs,
        accounts,
        foreignApps,
        foreignAssets,
