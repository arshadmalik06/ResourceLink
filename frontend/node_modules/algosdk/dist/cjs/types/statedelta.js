...
class AppParams {
    constructor(params) {
        ...
        this.sizeSponsor = params.sizeSponsor ?? address_js_1.Address.zeroAddress();
...
AppParams.encodingSchema = new index_js_1.NamedMapSchema((0, index_js_1.allOmitEmpty)([
    ...
    { key: 'v', valueSchema: new index_js_1.Uint64Schema() }, // version
    { key: 'ss', valueSchema: new index_js_1.AddressSchema() }, // sizeSponsor
    { key: 'fbr', valueSchema: new index_js_1.BooleanSchema() }, // foreignBoxReads
    { key: 'fba', valueSchema: new index_js_1.BooleanSchema() }, // familyBoxAccess
]));
/**
