...
class SignedTransaction {
    ...
    toEncodingData() {
        return new Map([
            ...
            [
                'pqsig',
                this.pqsig ? (0, index_js_1.encodedPQSigToEncodingData)(this.pqsig) : undefined,
            ],
            ['sgnr', this.sgnr],
        ]);
    }
    static fromEncodingData(data) {
        ...
        return new SignedTransaction({
            ...
            pqsig: data.get('pqsig')
                ? (0, index_js_1.encodedPQSigFromEncodingData)(data.get('pqsig'))
                : undefined,
            sgnr: data.get('sgnr'),
        });
    }
...
SignedTransaction.encodingSchema = new index_js_2.NamedMapSchema((0, index_js_2.allOmitEmpty)([
    ...
    {
        key: 'pqsig',
        valueSchema: new index_js_2.OptionalSchema(index_js_1.ENCODED_PQSIG_SCHEMA),
    },
    {
        key: 'sgnr',
