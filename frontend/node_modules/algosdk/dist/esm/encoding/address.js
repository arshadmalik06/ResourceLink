 ...
 */
export function addressFromPQKey(schemeBytes, key) {
    ...
    for (let salt = 0; salt <= PQ_SALT_MAX; salt++) {
        const toBeHashed = utils.concatArrays(PQ_ADDRESS_PREFIX, schemeBytes, Uint8Array.of(salt), key);
 ...
 */
export function addressFromPQSig(pqsig) {
