 ...
 */
export class AccountApplicationResource {
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            this.encodingSchemaValue = new NamedMapSchema([]);
 ...
 * for an account.
 */
export class AccountApplicationsInformationResponse {
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            this.encodingSchemaValue = new NamedMapSchema([]);
            this.encodingSchemaValue.pushEntries({ key: 'round', valueSchema: new Uint64Schema(), omitEmpty: true }, {
                key: 'application-resources',
                valueSchema: new OptionalSchema(new ArraySchema(AccountApplicationResource.encodingSchema)),
                omitEmpty: true,
            }, {
                key: 'next-token',
                valueSchema: new OptionalSchema(new StringSchema()),
...
export class BoxDescriptor {
    static get encodingSchema() {
        if (!this.encodingSchemaValue) {
            this.encodingSchemaValue = new NamedMapSchema([]);
            this.encodingSchemaValue.pushEntries({ key: 'name', valueSchema: new ByteArraySchema(), omitEmpty: true }, {
                key: 'value',
                valueSchema: new OptionalSchema(new ByteArraySchema()),
                omitEmpty: true,
            });
